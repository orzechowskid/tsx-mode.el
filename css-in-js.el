...
Checks for the presence of the `object-intervals` function shipped in recent
versions of Emacs."
...
(defun tsx-mode--css-post-command ()
  "Internal function."
  (tsx-mode--update-current-css-region))


(define-minor-mode tsx-mode-css
  "Toggle CSS-in-JS support for tsx-mode."
  :group 'tsx-mode
  :lighter nil
  ...
  (add-hook
   'post-command-hook
   'tsx-mode--css-post-command
   nil t))


(provide 'tsx-mode-css)
